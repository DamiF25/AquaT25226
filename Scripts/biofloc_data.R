...
ggsave(
  filename = "biofloc_tile_plot_with_parameters.tif",
  plot = p,
  width = 5.5, height = 4.7, dpi = 300, units = "in",
  compression = "lzw"
)
